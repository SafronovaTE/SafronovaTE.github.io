...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		function _set_interface() {
			...
			// добавлено для фикса некорректного позиционирования на мобилках
			$('#jquery-lightbox').css({
				width:				arrPageSizes[0],
			}).fadeIn();
			// Get page scroll
		...
		function ___getPageSize() {
			...
			if (self.innerHeight) {	// all except Explorer
				// изменено для фикса некорректного определения ширины на мобильниках
				if(document.documentElement.width/*clientWidth*/){
					windowWidth = document.documentElement.width/*clientWidth*/;
				} else {
